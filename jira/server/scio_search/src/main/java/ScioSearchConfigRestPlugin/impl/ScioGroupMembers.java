...
/**
 * Actual Api call:
 * https://docs.atlassian.com/software/jira/docs/api/REST/9.14.0/#api/2/group-getUsersFromGroup
 * GroupManager class doc to get details of the functions used:
 * https://docs.atlassian.com/software/jira/docs/api/7.1.4/com/atlassian/jira/security/groups/GroupManager.html
 */
@Named
@Path("/group_members")
public class ScioGroupMembers {
  ...
  public GroupMemberResponse getGroupMembers(
      @QueryParam("groupname") String groupName,
      @QueryParam("startAt") int startAt,
      @QueryParam("maxResults") int maxResults,
      @QueryParam("includeInactiveUsers") boolean includeInactiveUsers) {
    ...
    Page<ApplicationUser> users =
        groupManager.getUsersInGroup(groupName, includeInactiveUsers, pageRequest);
